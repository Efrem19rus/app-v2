...
export const HomeMainCard = ({ loading }) => {
  return (
    <div
      className={
    ...
    >
      <div className="w-full flex items-center justify-between font-sora">
        ...
        <h4 className="text-h4">
          {loading && <SkeletonElements type={"text"} />}Available
        </h4>
        <h4 className="text-h4 text-4e7dd9 font-bold ml-auto">
          {loading && <SkeletonElements type={"text"} />}30
        </h4>
      </div>
      ...
      <div className="w-full flex items-center justify-between font-sora mt-5">
        ...
        <h4 className="text-h4">
          {loading && <SkeletonElements type={"text"} />}Reporting
        </h4>
        <h4 className="text-h4 text-4e7dd9 font-bold ml-auto">
          {loading && <SkeletonElements type={"text"} />}2
        </h4>
      </div>
    </div>
  );
